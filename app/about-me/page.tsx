...
export default function AboutMePage() {
  return (
    <>
      <div>
        <NavBar />
        <Banner bg="/images/banner/man2.png" title="About Me" />
      </div>
      <div id="intro" className="text-center">
        ...
        <div className="bg-gray-500">
          ...
          <div
            className={`pt-12 pb-20 md:pb-32 md:px-24 xl:px-36 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 md:gap-12 text-gray-300 place-items-center`}
          >
