    ...
    <div className="absolute bottom-4 left-4">
      {response.logged ? (
        ...
        >
          ...
          {/* <button
            type="button"
            className="ml-auto -mx-1.5 -my-1.5 rounded-lg hover:font-bold inline-flex items-center justify-center h-8 w-8"
        ...
        >
          ...
          {/* <button
            type="button"
            className="ml-auto -mx-1.5 -my-1.5 rounded-lg inline-flex items-center justify-center h-8 w-8"
